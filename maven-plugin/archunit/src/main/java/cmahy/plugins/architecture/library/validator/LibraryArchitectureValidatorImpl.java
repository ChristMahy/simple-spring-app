package cmahy.plugins.architecture.library.validator;
...
public class LibraryArchitectureValidatorImpl implements ArchitectureValidator {

    private final ProjectConfiguration projectConfiguration;
    private final Log logger;

    public LibraryArchitectureValidatorImpl(ProjectConfiguration projectConfiguration, Log logger) {
