package cmahy.springapp.rabbitmq.publisher.controller;

import cmahy.springapp.rabbitmq.publisher.controller.vo.input.MessageInputVO;
import cmahy.springapp.rabbitmq.publisher.controller.vo.output.MessageOutputVO;
import cmahy.springapp.rabbitmq.publisher.domain.Message;
import cmahy.springapp.rabbitmq.publisher.service.RabbitMQService;
