package cmahy.webapp.user.adapter.webclient.config;

import cmahy.webapp.user.adapter.webclient.config.properties.user.SslOption;
import cmahy.webapp.user.adapter.webclient.config.properties.user.UserProperties;
import cmahy.webapp.user.adapter.webclient.config.properties.webclient.WebClientProperties;
