...
class ClientOrderInputUiToAppMapperTest {

    @InjectMocks
    private ClientOrderInputUiToAppMapper clientOrderInputUiToAppMapper;

    @Test
    void map() {
        assertDoesNotThrow(() -> {
            ClientOrderInputUiVo clientApiVo = new ClientOrderInputUiVo(
            ...
            ClientOrderInputAppVo actual = clientOrderInputUiToAppMapper.map(clientApiVo, tacos);
    ...
    void map_whenGivenValueIsNull_thenThrowNullAssertion() {
        assertThrows(NullException.class, () -> {
            ...
            clientOrderInputUiToAppMapper.map(null, tacos);
        });
    }
}