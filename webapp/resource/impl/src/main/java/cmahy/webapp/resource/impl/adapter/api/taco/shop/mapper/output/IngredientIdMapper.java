...
@Service
public class IngredientIdMapper {

    public IngredientApiId map(IngredientId id) {

        if (Objects.isNull(id)) {
            throw new NullException(IngredientId.class);
        }

        return new IngredientApiId(id.value());
    }
}
