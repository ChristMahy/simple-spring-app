package cmahy.simple.spring.webapp.resource.impl.adapter.api.error;

import cmahy.simple.spring.webapp.taco.shop.kernel.exception.UsageOnDeletionException;
...
@RestControllerAdvice(basePackages = { "cmahy.simple.spring.webapp.resource.impl.adapter.api" })
